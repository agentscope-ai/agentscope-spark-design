"use strict";(self.webpackChunk_agentscope_ai_design=self.webpackChunk_agentscope_ai_design||[]).push([[9850],{22549:function(Z,g,n){n.r(g),n.d(g,{default:function(){return P}});var E=n(48305),h=n.n(E),y=n(22781),s=n(75271),B=n(52676);function P(){var A=(0,s.useState)(`# \u89D2\u8272
...
# \u8F93\u51FA
- Prompt\uFF1A\u7B26\u5408\u8981\u6C42\u7684Prompt\u3002`),d=h()(A,2),T=d[0],D=d[1];return(0,B.jsx)(y.Z,{tipsText:!1,value:T,onChange:D,maxLength:5e3,variables:[{code:"city"},{code:"foo"},{code:"user"},{code:"\u6A21\u578B\u8F93\u5165"}]})}},22781:function(Z,g,n){n.d(g,{Z:function(){return ln}});var E=n(82092),h=n.n(E),y=n(15558),s=n.n(y),B=n(48305),P=n.n(B),A=n(53649),d=n.n(A),T=n(39982),D=n(19487),j=n(56664),V=n(15222),K=n(45372),U=n(80047),$=n(85412),z=n(82187),k=n.n(z),l=n(75271),H=n(25298),M=n.n(H),G=n(17069),O=n.n(G),J=n(21742),Y=n.n(J),Q=n(83136),X=n.n(Q),c=n(25451),w=function(r){Y()(t,r);var e=X()(t);function t(o){var a;return M()(this,t),a=e.call(this),a.name=o,a}return O()(t,[{key:"eq",value:function(a){return a.name===this.name}},{key:"toDOM",value:function(){var a=document.createElement("span");return a.setAttribute("aria-hidden","true"),a.className="cm-prompt-var",a.textContent="${".concat(this.name,"}"),a}},{key:"ignoreEvent",value:function(){return!1}}]),t}(c.l9),L=new c.Y1({regexp:/\$\{([\w\u4e00-\u9fa5]+)\}/g,decoration:function(e){return c.p.replace({widget:new w(e[1])})}}),q=c.lg.fromClass(function(){function r(e){M()(this,r),h()(this,"placeholders",void 0),this.placeholders=L.createDeco(e)}return O()(r,[{key:"update",value:function(t){this.placeholders=L.updateDeco(t,this.placeholders)}}]),r}(),{decorations:function(e){return e.placeholders},provide:function(e){return c.tk.atomicRanges.of(function(t){var o;return((o=t.plugin(e))===null||o===void 0?void 0:o.placeholders)||c.p.none})}}),_=[q],nn=n(26068),R=n.n(nn),tn=n(14179);function en(){var r=arguments.length>0&&arguments[0]!==void 0?arguments[0]:[],e=arguments.length>1?arguments[1]:void 0,t=e.onCreate,o=e.createBtnText;return(0,tn.ys)({override:[function(a){var m,u=a.matchBefore(/\/(\w+)?/);return!u||u&&u.from===u.to&&!a.explicit?null:{from:(m=u==null?void 0:u.from)!==null&&m!==void 0?m:0,options:(t?[].concat(s()(r),[{label:"/NEW_VAR",boost:-99}]):r).map(function(p){return R()(R()({},p),{},{displayLabel:p.label==="/NEW_VAR"?o:p.label.slice(1),apply:function(v,x,f,C){if(x.label==="/NEW_VAR")return v.dispatch({changes:{from:f,to:C,insert:""}}),t==null?void 0:t();var F=x.label.slice(1),S="${".concat(F,"}");v.dispatch({changes:{from:f,to:C,insert:S}})}})})}}]})}var i=n(52676),N,I,on=(0,$.kc)(function(r){var e=r.css,t=r.token;return{onCreate:e(N||(N=d()([`
