import { sleep, type IAgentScopeRuntimeWebUIMessage } from "@agentscope-ai/chat";
...
import useInputQueueController, { type QueueSubmitNow } from "./useInputQueueController";
...
export default function useChatController() {
  ...
  const handleReconnectRef = useRef<((sessionId: string) => Promise<void>) | null>(null);
  ...
  const submitNow = useCallback<QueueSubmitNow>(async (
  ...
  useEffect(() => {
    ...
    const equivalentQueueSession = sameQueueSession(prevSessionId, currentSessionId);
    if (
      !prevSessionId ||
  ...
  }, [clearDrainTimer, currentSessionId, resolveQueueSessionId, sameQueueSession]);
